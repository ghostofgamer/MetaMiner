...
public class ShadowsPropertiesDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        EditorGUI.LabelField(propertyPosition, new GUIContent("Location Offset"));
        propertyPosition.y += EditorGUIUtility.singleLineHeight;
        ...
        //    {
                ...
                //propertyPosition.y += 20f + 150f * (singleShadowProp.isExpanded ? 1f : 0f);
        ...
        //if (GUI.Button(propertyPosition, "clear shadows"))
        //{
